...
const LeafLoading = ({ isLoading }) => {
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center bg-[#F5F7F4] z-50 transition-opacity duration-500 ${isLoading ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      <div className="text-center relative z-10">
        <h1 className="text-4xl font-bold text-[#16221D] mb-3">AushadhSanchaya</h1>
        <p className="text-[#4D6E60] mb-8">Loading your App</p>
      </div>
      <canvas 
        ref={canvasRef} 
